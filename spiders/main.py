...
def run_plots(json_path: Path, min_n: int, max_n: int) -> None:
    ...
    for cat in categories:
        ...
        for ptype in types:
            ...
            plot_motif_counts_and_fraction(type_summary, cat_out_dir, min_n, max_n, suffix=label)
            plot_x_composition(type_summary, cat_out_dir, min_n, max_n, suffix=label)
...
def main() -> None:
    ...
    "MaSp1": [
        "masp1", "ma sp1", "spidroin-1", "spidroin 1a", "spidroin 1b", "spidroin 1c",
        "dragline silk spidroin 1", "dragline 1", "major ampullate spidroin 1", "major ampullate spidroin i",
    ],
    "MaSp2": [
        "masp2", "ma sp2", "spidroin-2", "dragline silk fibroin 2",
        "ampullatespidroin2a", "ampullatespidroin2b", "major ampullate spidroin 2", "major ampullate spidroin ii",
    ],
    "MaSp3": [
    "masp3", "ma sp3", "major ampullate spidroin 3", "ampullatespidroin3",
    ],
    "Major_ampullate_unspecified": [
        "major ampullate spidroin",
    ],
    "MiSp": [
        "minor ampullate", "misp", "minorspidroina",
    ],
    "AcSp": [
        "aciniform", "acsp", "aciniformspidroin1", "aciniformspidroin2",
    ],
    "TuSp": [
        "tubuliform", "tusp",
    ],
    ...
    "PySp": [
        "pyriform", "piriform", "piriformspidroinvariant", "pysp",
    ],
    "AgSp": [
        "aggregate", "agsp",
    ],
    "CrSp": [
        "cribellate", "cribellar spidroin", "pseudoflagelliform", "pseudoflag",
    ],
    "Ecribellate_glue": [
        "ecribellate glue", "glue spidroin",
    ],
    "CySp": [
        "cylindrical", "cysp",
    ],
    "ASp_unknown": [],  # fallback if nothing matched
            }
