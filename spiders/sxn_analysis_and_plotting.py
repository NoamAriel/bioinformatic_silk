...
def run_plots(json_path: Path, min_n: int, max_n: int, *, out_dir_override: Path | None = None) -> None:
    ...
    if not records:
        ...
        return
    _plot_records(records, summary, json_path, min_n, max_n, out_dir_override=out_dir_override)
...
def run_filtered_plots(
    ...
    *,
    ...
    _plot_records(filtered, filtered_summary, json_path, min_n, max_n, out_dir_override=out_dir_override)
...
data_root: Path | None = Path(r"D:\python\LHuge_data_for_bioinformatic_project\spiders\ncbi_fibroin_sequences") # or None for default
plots_root: Path | None = Path(r"D:\python\Lab\spiders\ncbi_fibroin_sequences") # or None for default
