...
tree_path= Path(r"D:\python\bioinformatic_silk\caddisfly\ncbi_fibroin_sequences\phylo_tree.json")
index_path= Path(r"D:\python\bioinformatic_silk\caddisfly\Species_Index.md")
out_path= Path(r"D:\python\bioinformatic_silk\caddisfly\taxonomy_tree")
data_root= Path(r"D:\python\bioinformatic_silk\caddisfly\ncbi_fibroin_sequences")
...
rank_from: str | None = None     # integripalpia     annulipalpia                     # default: None; e.g., "Family" or "Hydropsychoidea"
