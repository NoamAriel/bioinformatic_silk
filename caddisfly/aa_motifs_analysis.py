...
taxonomy_terms = ["Trichoptera"]  # or [] / None annulipalpia, integripalpia, Trichoptera
...
phylo_tree_path = Path("D:/python/bioinformatic_silk/caddisfly/ncbi_fibroin_sequences/phylo_tree.json")
