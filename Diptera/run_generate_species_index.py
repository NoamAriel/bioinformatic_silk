...
data_root: Path | None = Path(r"D:\python\bioinformatic_silk\Diptera\ncbi_fibroin_sequences\Diptera")
output_path: Path | None = Path(r"D:\python\bioinformatic_silk\Diptera")
