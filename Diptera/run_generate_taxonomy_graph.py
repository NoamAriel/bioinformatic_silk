...
tree_path= Path(r"D:\python\Lab\Diptera\ncbi_fibroin_sequences\phylo_tree.json")
index_path= Path(r"D:\python\Lab\Diptera\Species_Index.md")
out_path= Path(r"D:\python\Lab\Diptera\taxonomy_tree")
data_root= Path(r"D:\python\Lab\Diptera\ncbi_fibroin_sequences")
