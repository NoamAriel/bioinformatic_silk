...
tree_path= Path(r"D:\python\bioinformatic_silk\Diptera\ncbi_fibroin_sequences\phylo_tree.json")
index_path= Path(r"D:\python\bioinformatic_silk\Diptera\Species_Index.md")
out_path= Path(r"D:\python\bioinformatic_silk\Diptera\taxonomy_tree")
data_root= Path(r"D:\python\bioinformatic_silk\Diptera\ncbi_fibroin_sequences")
...
import libraries.generate_taxonomy_graph as gtg
...
print(f"Using generate_taxonomy_graph from: {gtg.__file__}")
