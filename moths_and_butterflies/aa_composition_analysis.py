...
json_path, md_path = analyze_from_root(
    root=root,
    letters="agvlimfwhkrdepstcynq",       #stfwhydenqrk avli gp  cm   krh    ednqkrh  nq   wpfh     sty       wfy              # amino acids you care about. for example, "sae" or "c" or "gyplsrh"
    taxonomy_terms=["Bombyx Mori"],   # lepidoptera # neolepidoptera (moths) Papilionoidea (butterflies)
       # "gelechioidea","bombycoidea","noctuoidea","pyraloidea","tortricoidea","yponomeutoidea" (all others)   # or [] / None
    protein_types=["heavy chain"],        # or [] / None
    partial_full=None,                  # "full", "partial", or None
    length_range=(5000,9000),                    # e.g., (100, 2450) or None
