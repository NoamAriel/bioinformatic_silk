...
def main() -> None:
    ...
    expected_types = {
        "fibroin 1": [
            "fibroin 1", "fib-1", "f1", "fibroin I", "fibroin type 1"],
        "fibroin 2": [
            "fibroin 2", "fib-2", "f2", "fibroin II", "fibroin type 2"],
        "fibroin 3": [
            "fibroin 3", "fib-3", "f3", "fibroin III", "fibroin type 3"],
        "fibroin 4": [
            "fibroin 4", "fib-4", "f4", "fibroin IV", "fibroin type 4"],
    "heavy chain": [
