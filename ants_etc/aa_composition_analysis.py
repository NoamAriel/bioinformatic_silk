...
phylo_tree_json = Path(r"D:\python\bioinformatic_silk\ants_etc\ncbi_fibroin_sequences\phylo_tree.json")
...
json_path, md_path = analyze_from_root(
    root=root,
    letters="avli",       #stfwhydenqrk avli gp  cm   krh   nq  ednqkrh     wpfh     sty    wfy                      # amino acids you care about. for example, "sae" or "c" or "gyplsrh"
