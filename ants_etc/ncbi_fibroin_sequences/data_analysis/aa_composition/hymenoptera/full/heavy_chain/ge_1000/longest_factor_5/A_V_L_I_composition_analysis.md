...
- JSON data: `A_V_L_I_composition_analysis.json`
- Target letters: **A, V, L, I**
- Filters: taxonomy in {hymenoptera}; type contains {heavy chain}; partial_full == 'full'; length >= 1000; length >= (longest_length / 5) [scope: species] (after all other filters)
---
## Global Summary

- Number of sequences analyzed: **116**
- Total residues across all sequences: **161575**
...
|  :--- | :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Osmia bicornis bicornis | heavy chain | full | `XP_029044767` | 1214 | 213 | 17.55% | 35 | 2.88% | 34 | 2.80% | 38 | 3.13% |
| Osmia bicornis bicornis | heavy chain | full | `XP_029044772` | 1173 | 205 | 17.48% | 34 | 2.90% | 34 | 2.90% | 37 | 3.15% |
...
| Bombus impatiens | heavy chain | full | `XP_033175829` | 1315 | 96 | 7.30% | 45 | 3.42% | 25 | 1.90% | 20 | 1.52% |
| Bombus impatiens | heavy chain | full | `XP_033175830` | 1313 | 95 | 7.24% | 45 | 3.43% | 25 | 1.90% | 20 | 1.52% |
| Bombus impatiens | heavy chain | full | `XP_033175831` | 1295 | 96 | 7.41% | 44 | 3.40% | 25 | 1.93% | 20 | 1.54% |
| Bombus impatiens | heavy chain | full | `XP_033175832` | 1282 | 96 | 7.49% | 45 | 3.51% | 24 | 1.87% | 19 | 1.48% |
| Bombus impatiens | heavy chain | full | `XP_033176162` | 1242 | 237 | 19.08% | 37 | 2.98% | 38 | 3.06% | 45 | 3.62% |
...
| Bombus affinis | heavy chain | full | `XP_050579536` | 1298 | 99 | 7.63% | 46 | 3.54% | 25 | 1.93% | 24 | 1.85% |
| Bombus affinis | heavy chain | full | `XP_050579537` | 1298 | 99 | 7.63% | 46 | 3.54% | 25 | 1.93% | 24 | 1.85% |
| Bombus affinis | heavy chain | full | `XP_050579538` | 1250 | 97 | 7.76% | 45 | 3.60% | 24 | 1.92% | 23 | 1.84% |
| Bombus affinis | heavy chain | full | `XP_050579539` | 1250 | 97 | 7.76% | 45 | 3.60% | 24 | 1.92% | 23 | 1.84% |
| Bombus affinis | heavy chain | full | `XP_050579540` | 1250 | 97 | 7.76% | 45 | 3.60% | 24 | 1.92% | 23 | 1.84% |
| Bombus affinis | heavy chain | full | `XP_050579541` | 1250 | 97 | 7.76% | 45 | 3.60% | 24 | 1.92% | 23 | 1.84% |
| Bombus affinis | heavy chain | full | `XP_050579542` | 1250 | 97 | 7.76% | 45 | 3.60% | 25 | 2.00% | 23 | 1.84% |
| Bombus affinis | heavy chain | full | `XP_050579543` | 1202 | 95 | 7.90% | 44 | 3.66% | 24 | 2.00% | 22 | 1.83% |
| Bombus affinis | heavy chain | full | `XP_050579546` | 1202 | 95 | 7.90% | 44 | 3.66% | 24 | 2.00% | 22 | 1.83% |
| Bombus affinis | heavy chain | full | `XP_050579547` | 1202 | 95 | 7.90% | 45 | 3.74% | 25 | 2.08% | 23 | 1.91% |
| Bombus affinis | heavy chain | full | `XP_050587182` | 1160 | 214 | 18.45% | 45 | 3.88% | 39 | 3.36% | 41 | 3.53% |
| Bombus affinis | heavy chain | full | `XP_050587183` | 1159 | 213 | 18.38% | 45 | 3.88% | 39 | 3.36% | 41 | 3.54% |
...
| Organism | Type | Partial/Full | Accession ID | Length | A Count | A % | V Count | V % | L Count | L % | I Count | I % |
|  :--- | :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Cataglyphis hispanica | heavy chain | full | `XP_050448088` | 1330 | 90 | 6.77% | 49 | 3.68% | 27 | 2.03% | 34 | 2.56% |

### Family: Vespoidea
| Organism | Type | Partial/Full | Accession ID | Length | A Count | A % | V Count | V % | L Count | L % | I Count | I % |
|  :--- | :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Polistes fuscatus | heavy chain | full | `XP_043491512` | 1420 | 179 | 12.61% | 78 | 5.49% | 62 | 4.37% | 44 | 3.10% |

### Family: Chrysidoidea
| Organism | Type | Partial/Full | Accession ID | Length | A Count | A % | V Count | V % | L Count | L % | I Count | I % |
|  :--- | :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Prorops nasuta | heavy chain | full | `XP_066592650` | 5606 | 1094 | 19.51% | 365 | 6.51% | 66 | 1.18% | 159 | 2.84% |
...
| Organism | Type | Partial/Full | Accession ID | Length | A Count | A % | V Count | V % | L Count | L % | I Count | I % |
|  :--- | :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Diachasmimorpha longicaudata | heavy chain | full | `XP_063986597` | 1975 | 249 | 12.61% | 70 | 3.54% | 13 | 0.66% | 9 | 0.46% |
| Diachasmimorpha longicaudata | heavy chain | full | `XP_063986598` | 1955 | 245 | 12.53% | 70 | 3.58% | 13 | 0.66% | 9 | 0.46% |
| Diachasmimorpha longicaudata | heavy chain | full | `XP_063986600` | 1955 | 246 | 12.58% | 70 | 3.58% | 13 | 0.66% | 9 | 0.46% |
| Diachasmimorpha longicaudata | heavy chain | full | `XP_063986601` | 1933 | 245 | 12.67% | 68 | 3.52% | 13 | 0.67% | 9 | 0.47% |
| Diachasmimorpha longicaudata | heavy chain | full | `XP_063986602` | 1807 | 225 | 12.45% | 66 | 3.65% | 13 | 0.72% | 9 | 0.50% |
| Microplitis mediator | heavy chain | full | `XP_057332812` | 1173 | 134 | 11.42% | 2 | 0.17% | 6 | 0.51% | 5 | 0.43% |
| Microplitis mediator | heavy chain | full | `XP_057332813` | 1121 | 128 | 11.42% | 2 | 0.18% | 6 | 0.54% | 5 | 0.45% |
| Microplitis demolitor | heavy chain | full | `XP_008553238` | 1006 | 141 | 14.02% | 2 | 0.20% | 5 | 0.50% | 6 | 0.60% |
| Cotesia glomerata | heavy chain | full | `XP_044580933` | 1071 | 176 | 16.43% | 19 | 1.77% | 22 | 2.05% | 10 | 0.93% |
| Cotesia glomerata | heavy chain | full | `XP_044580934` | 1071 | 172 | 16.06% | 22 | 2.05% | 21 | 1.96% | 12 | 1.12% |
| Aphidius gifuensis | heavy chain | full | `XP_044008663` | 1948 | 162 | 8.32% | 155 | 7.96% | 8 | 0.41% | 15 | 0.77% |
| Aphidius gifuensis | heavy chain | full | `XP_044008664` | 1948 | 162 | 8.32% | 154 | 7.91% | 8 | 0.41% | 15 | 0.77% |
| Aphidius gifuensis | heavy chain | full | `XP_044008666` | 1925 | 161 | 8.36% | 152 | 7.90% | 8 | 0.42% | 15 | 0.78% |
| Aphidius gifuensis | heavy chain | full | `XP_044008680` | 1695 | 142 | 8.38% | 133 | 7.85% | 8 | 0.47% | 15 | 0.88% |

## Superfamily: Proctotrupomorpha
...
| Organism | Type | Partial/Full | Accession ID | Length | A Count | A % | V Count | V % | L Count | L % | I Count | I % |
|  :--- | :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Leptopilina boulardi | heavy chain | full | `XP_051157026` | 2315 | 5 | 0.22% | 64 | 2.76% | 159 | 6.87% | 205 | 8.86% |
| Leptopilina boulardi | heavy chain | full | `XP_051157027` | 2243 | 5 | 0.22% | 62 | 2.76% | 155 | 6.91% | 199 | 8.87% |
| Leptopilina boulardi | heavy chain | full | `XP_051157028` | 2243 | 5 | 0.22% | 62 | 2.76% | 156 | 6.95% | 199 | 8.87% |
| Leptopilina boulardi | heavy chain | full | `XP_051157030` | 2171 | 5 | 0.23% | 60 | 2.76% | 149 | 6.86% | 195 | 8.98% |
| Leptopilina boulardi | heavy chain | full | `XP_051157031` | 2099 | 4 | 0.19% | 58 | 2.76% | 143 | 6.81% | 191 | 9.10% |
| Leptopilina boulardi | heavy chain | full | `XP_051157032` | 1963 | 4 | 0.20% | 55 | 2.80% | 135 | 6.88% | 178 | 9.07% |
| Leptopilina boulardi | heavy chain | full | `XP_051157033` | 1923 | 4 | 0.21% | 53 | 2.76% | 131 | 6.81% | 180 | 9.36% |
| Leptopilina boulardi | heavy chain | full | `XP_051157034` | 1923 | 4 | 0.21% | 54 | 2.81% | 132 | 6.86% | 177 | 9.20% |
| Leptopilina boulardi | heavy chain | full | `XP_051157035` | 1907 | 5 | 0.26% | 51 | 2.67% | 135 | 7.08% | 163 | 8.55% |
| Belonocnema kinseyi | heavy chain | full | `XP_033231227` | 1285 | 161 | 12.53% | 49 | 3.81% | 39 | 3.04% | 33 | 2.57% |