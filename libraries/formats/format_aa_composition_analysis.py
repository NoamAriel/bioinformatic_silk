...
phylo_tree_json = Path(r"D:\python\Lab\caddisfly\ncbi_fibroin_sequences\phylo_tree.json")
...
json_path, md_path = analyze_from_root(
    root=root,
    letters="avli",                # "sty", avli cm   krh  nq gp  #stfwhydenqrk   ed nqkrh  ednqkrh   wpfh    wfy      # amino acids you care about. for example, "sae" or "c" or "gyplsrh"
